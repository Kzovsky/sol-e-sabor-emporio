        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-sol hover:text-sol-light transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="flex items-center">
                ...
                <a href="tel:+551199999999" className="text-white/80 hover:text-sol transition-colors">(11) 99999-9999</a>
              </p>
              <p className="flex items-center">
                <MessageSquare className="h-5 w-5 mr-3 text-sol flex-shrink-0" />
                <a href="mailto:contato@solesabor.com" className="text-white/80 hover:text-sol transition-colors">contato@solesabor.com</a>
              </p>
            </div>
            <div className="mt-6">
              <h4 className="font-medium mb-2">Horário de Funcionamento</h4>
              <p className="text-white/80">Segunda a Sábado: 9h às 20h</p>
              <p className="text-white/80">Domingo: 9h às 15h</p>
            </div>
          </div>
        </div>
